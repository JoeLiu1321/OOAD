    ...
    public ActionListener outputListener = new ActionListener() {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (option == JFileChooser.APPROVE_OPTION) {
                ...
                String format = (String) JOptionPane.showInputDialog(null, "請選擇格式", "選擇輸出格式", type, null, formats,
                        formats[0]);
                if (format == null)
                    return;
                BufferedImage bufferedImage = new BufferedImage(drawer.getWidth(), drawer.getHeight(),
