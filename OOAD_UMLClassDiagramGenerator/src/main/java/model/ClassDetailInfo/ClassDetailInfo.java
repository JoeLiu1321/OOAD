...
public class ClassDetailInfo {
	...
	public ClassDetailInfo(String class_name, MemberVariable MemberVariable, MemberFunction MemberFunction,
			ClassMemberAbstract ClassRelarionship) {
