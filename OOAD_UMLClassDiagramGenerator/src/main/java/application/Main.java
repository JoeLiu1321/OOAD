...
public class Main {
	public static void main(String[] args) {
		...
		String[] classNames = { "FileOutputFormat", "FileOutputFormatImpl", "ClassDiagramGenerator", "UmlClassDiagram",
				"relation", "UserManager", "User", "ClassRelationGenerator", "ClassUnitGenerator" };
